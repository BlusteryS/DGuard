...
class Events implements Listener {
	...
	public function onBreak(BlockBreakEvent $event): void {
		...
		$region = Methods::getInstance()->getRegion($block->getPosition()->getFloorX(), $block->getPosition()->getFloorZ(), $player->getWorld()->getFolderName());
			...
			if ($itemHand === Item::STICK) {
				...
				if (isset(DGuard::getInstance()->wand[$n])) {
					if (DGuard::getInstance()->wand[$n]) {
						DGuard::getInstance()->set_pos(TRUE, $block->getPosition()->getFloorX(), $block->getPosition()->getFloorZ(), $player->getWorld()->getFolderName(), $player);
					} else {
						DGuard::getInstance()->set_pos(FALSE, $block->getPosition()->getFloorX(), $block->getPosition()->getFloorZ(), $player->getWorld()->getFolderName(), $player);
					}
				} else {
					DGuard::getInstance()->set_pos(TRUE, $block->getPosition()->getFloorX(), $block->getPosition()->getFloorZ(), $player->getWorld()->getFolderName(), $player);
				}
	...
	public function onDamage(EntityDamageEvent $event): void {
		if ($event instanceof EntityDamageByEntityEvent) {
			...
			if (($region = Methods::getInstance()->getRegion($player->getPosition()->getFloorX(), $player->getPosition()->getFloorZ(), $player->getWorld()->getFolderName())) === "") return;
